...
import { Button, Label, SpinnerScreeen } from "@shared-ui";
...
export default function ProjectCreate() {
  ...
  const createProject =  trpc.site.create.useMutation({
    onSuccess(data) {
      router.push("/home");
    }
  });
  ...
  return (
    <>
          ...
          >
            <FormProvider {...formMethods}>
              <div
                className="mb-4"
              >
                <Label label="Create a site" size="text-2xl" weight="font-bold" />
              </div>
              <div
                className="mb-4"
              >
      ...
      {createProject.isLoading && <SpinnerScreeen />}
    </>
  )
}